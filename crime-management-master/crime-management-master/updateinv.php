...
<div class="row">
  ...
  <form action="updateinv2.php" method="get">
    <div class="row">
      <div class="col-25">
        <label for="inv_id">Enter inv_id</label>
      </div>
      <div class="col-75">
        <input type="text" id="inv_id" name="inv_id" placeholder="INVESTIGATION Id...">
      </div>
    </div>
    <div class="row">
      <div class="col-25">
        <label for="date_of_end">date_of_end</label>
      </div>
      <div class="col-75">
        <input type="date" name="date_of_end" placeholder="date of end of the investigation..">
      </div>
    </div>
</div>
<br/>
